...
const { AlertsAndDialogsData } = require('../../../testData/practice/AlertsAndDialogsData');
const { AlertsAndDialogsActions } = require('../../../helpers/practice/AlertsAndDialogsActions');
const { AlertsAndDialogsAssertions } = require('../../../helpers/practice/AlertsAndDialogsAssertions');
